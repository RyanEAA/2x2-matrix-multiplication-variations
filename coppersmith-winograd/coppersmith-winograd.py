...
def main():
    ...
    for idx, target_perm in enumerate(permutations(TARGETS), start=1):
        ...
        p = cw_products(A_prime, B_prime, prefix="p")
        reconstructed = cw_reconstruct(p)
    ...
    for r in results:
        ...
        print(f"Coppersmith-Winograd reconstruction equals A'B'? {r['reconstruction_valid']}")
